...
public class CombateIncendioRepository : ICombateIncendioRepository
{
    ...
    public async Task<IEnumerable<Domain.Entidades.Cadastros.CombateIncendio.CombateIncendio>> GetAllAsync(DateTime? offsetDate, Guid idUser, string userName)
    {
        ...
        {
            return await _dbConnection.QueryAsync<Domain.Entidades.Cadastros.CombateIncendio.CombateIncendio>(query, new { IdExecutor = idUser, Piloto = userName });
        }
    }
    ...
    public async Task<IEnumerable<Domain.Entidades.Cadastros.CombateIncendio.CombateIncendio>> GetListByIdsAsync(List<int> ids,int idEmpresa, int statusEnvio)
    {
        ...
        string query = @"SELECT * FROM CombateIncendio 
                     ...
                     AND IsMapa = 0";
        return await _dbConnection.QueryAsync<Domain.Entidades.Cadastros.CombateIncendio.CombateIncendio>(query, new { Ids = ids, IdEmpresa = idEmpresa, StatusEnvio = statusEnvio });
    }
