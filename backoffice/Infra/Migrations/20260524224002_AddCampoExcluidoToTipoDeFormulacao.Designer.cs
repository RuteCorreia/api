...
namespace Infra.Migrations
{
    ...
    [Migration("20260524224002_AddCampoExcluidoToTipoDeFormulacao")]
    partial class AddCampoExcluidoToTipoDeFormulacao
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entidades.Cadastros.Aplicacao.AplicacaoRelatorio", b =>
                {
                    ...
                    b.HasIndex("RelatorioAplicacaoId");
            ...
            modelBuilder.Entity("Domain.Entidades.Cadastros.Classe.Classe", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ClassePublica")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domain.Entidades.Cadastros.Controle_De_Frota.ControleDeFrota", b =>
                {
                    ...
                    b.Property<string>("ChecklistVeiculo")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Combustivel")
                        .HasColumnType("nvarchar(max)");

                    b.Property<decimal?>("CombustivelFinal")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("CombustivelInicial")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("CombustivelRemanescente")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("CombustivelUtilizado")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal?>("HorasAplicacao")
                        .HasColumnType("decimal(18,2)");

                    b.Property<string>("HorimetroFinal")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("HorimetroInicial")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Horimetros")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("NomeExecutor")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<decimal?>("OleoMotor")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("QtdeCombustivel")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Domain.Entidades.Cadastros.FrotaBateria.FrotaBateria", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("CicloFinal")
                        .HasColumnType("int");

                    b.Property<int?>("CicloInicial")
                        .HasColumnType("int");
                    ...
                    b.ToTable("FrotaBaterias");
                });

            modelBuilder.Entity("Domain.Entidades.Cadastros.FrotaGerador.FrotaGerador", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("DataTrocaOleo")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("IdGerador");

                    b.ToTable("FrotaGeradores");
                });

            modelBuilder.Entity("Domain.Entidades.Cadastros.FrotaMotobomba.FrotaMotobomba", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("IdMotobomba")
                        .HasColumnType("int");

                    b.Property<string>("Identificacao")
                        .HasColumnType("nvarchar(max)");

                    b.Property<double?>("LitrosGasolina")
                        .HasColumnType("float");

                    b.Property<double?>("LitrosOleo")
                        .HasColumnType("float");
                    ...
                    b.HasIndex("IdMotobomba");

                    b.ToTable("FrotaMotobombas");
                });

            modelBuilder.Entity("Domain.Entidades.Cadastros.Gerador.Gerador", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<long>("QuantidadeHorasTroca")
            ...
            modelBuilder.Entity("Domain.Entidades.Cadastros.IdentificadorAplicacao.IdentificadorAplicacao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("IdentificadorAplicacao");
                });
            ...
            modelBuilder.Entity("Domain.Entidades.Cadastros.Motobomba.Motobomba", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entidades.Cadastros.ProdutoAplicado.ProdutoAplicado", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal?>("DosagemProdutoAplicado")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<string>("UnidadeProdutoAplicado")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("Id");

                    b.ToTable("ProdutoAplicado");
                });

            modelBuilder.Entity("Domain.Entidades.Cadastros.ReceituarioAgronomico.ReceituarioAgronomico", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ReceituarioAgronomico");
                });
            ...
            modelBuilder.Entity("Domain.Entidades.User.Usuario", b =>
                {
                    ...
                    b.Property<string>("FlagTermoResp")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domain.Entidades.Cadastros.Aplicacao.AplicacaoRelatorio", b =>
                {
                    ...
                    b.HasOne("Domain.Entidades.Cadastros.RelatorioAplicacao.RelatorioAplicacao", null)
                        .WithMany("Aplicacoes")
                        .HasForeignKey("RelatorioAplicacaoId");
            ...
            modelBuilder.Entity("Domain.Entidades.Cadastros.Controle_De_Frota.ControleDeFrota", b =>
                {
                    ...
                    b.HasOne("Domain.Entidades.Cadastros.Veiculo.Veiculo", "Veiculo")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entidades.Cadastros.FrotaBateria.FrotaBateria", b =>
                {
                    b.HasOne("Domain.Entidades.Cadastros.Bateria.Bateria", "Bateria")
                        .WithMany()
                    ...
                    b.HasOne("Domain.Entidades.Cadastros.Controle_De_Frota.ControleDeFrota", "ControleDeFrota")
                        .WithMany()
                        .HasForeignKey("IdFrota");

                    b.Navigation("Bateria");

                    b.Navigation("ControleDeFrota");
            ...
            modelBuilder.Entity("Domain.Entidades.Cadastros.FrotaGerador.FrotaGerador", b =>
                {
                    ...
                    b.HasOne("Domain.Entidades.Cadastros.Gerador.Gerador", "Gerador")
                        .WithMany()
                        .HasForeignKey("IdGerador");

                    b.Navigation("ControleDeFrota");

                    b.Navigation("Empresa");

                    b.Navigation("Gerador");
                });
            ...
            modelBuilder.Entity("Domain.Entidades.Cadastros.FrotaMotobomba.FrotaMotobomba", b =>
                {
                    ...
                    b.HasOne("Domain.Entidades.Cadastros.Motobomba.Motobomba", "Motobomba")
                        .WithMany()
                        .HasForeignKey("IdMotobomba");

                    b.Navigation("ControleDeFrota");

                    b.Navigation("Empresa");

                    b.Navigation("Motobomba");
                });
