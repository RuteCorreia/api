...
namespace Backoffice.Controllers
{
    public class EquipamentosController : Controller
    {
        ...
        public EquipamentosController(ContextBase context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Equipamento != null ? 
                          ...
                          Problem("Entity set 'ContextBase.Equipamento'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome")] Equipamento equipamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome")] Equipamento equipamento)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ContextBase.Equipamento'  is null.");
            }
            var equipamento = await _context.Equipamento.FindAsync(id);
            if (equipamento != null)
            {
