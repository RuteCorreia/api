...
{
    public class RelatorioItemViewModelToDomainMappingProfile : Profile
    {
        public RelatorioItemViewModelToDomainMappingProfile()
        {
            CreateMap<RelatorioItemViewModel, Domain.Entidades.Cadastros.Aplicacao.AplicacaoRelatorioItem>()
