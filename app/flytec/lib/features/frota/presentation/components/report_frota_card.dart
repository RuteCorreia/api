...
class ReportFrotaCard extends StatelessWidget {
  final List<ReportFrotaModel> _reportFrotaModel;
  final int _index;
  const ReportFrotaCard(
      {super.key,
      required List<ReportFrotaModel> reportFrotaModel,
      required int index})
      : _reportFrotaModel = reportFrotaModel,
        _index = index;

  Color get _getColorStateColor {
    if (_reportFrotaModel[_index].state == DashBoardState.Enviado) {
      return Colors.blue;
    }
    if (_reportFrotaModel[_index].state == DashBoardState.Pronto) {
      return Colors.green;
    }
    if (_reportFrotaModel[_index].state == DashBoardState.Incompleto) {
      return const Color(0xFFFF9900);
    }
    if (_reportFrotaModel[_index].state == DashBoardState.NaoEnviado) {
      return Colors.red;
    }
    return Colors.blue;
  }
  ...
  DateTime get _date {
    if (_reportFrotaModel[_index].createdAt != null) {
      return DateTime.fromMillisecondsSinceEpoch(
          _reportFrotaModel[_index].createdAt!);
    }
    return DateTime.now();
  }
          ...
          children: [
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    _reportFrotaModel[_index].placaVeiculo ?? "",
