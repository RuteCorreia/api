...
class ReportCombateIncendioPage extends StatefulWidget {
  final File? report;
  const ReportCombateIncendioPage({super.key, this.report});

  @override
  State<ReportCombateIncendioPage> createState() =>
      _ReportCombateIncendioPageState();
}

class _ReportCombateIncendioPageState extends State<ReportCombateIncendioPage> {
          ...
          FloatingActionButton(
            ...
            onPressed: () async {
              try {
                ...
                Util.toastSucesso('Download do Relatório concluí­do');
              } catch (e) {
                Util.toastErro(
